...
if __name__ == "__main__":
    ...
    torch.save(optimal_vae_model, 'refined_optimal_vae.pth')

    with open('refined_configs.pkl', 'wb') as f:
        pickle.dump(configs, f)

    with open('refined_optimal_config.pkl', 'wb') as f:
